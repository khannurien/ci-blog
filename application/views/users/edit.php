						...
						<?php echo form_open('users/edit'); ?>
							<div class="form-group">
								...
								<div class="input-group mb-2">
									...
									<input type="text" class="form-control" name="username" value="<?php echo set_value('username', @$users_item['usr_nick']); ?>" />
								</div>
								...
								<div class="input-group mb-2">
									...
									<input type="mail" class="form-control" name="mail" value="<?php echo set_value('mail', @$users_item['usr_mail']); ?>" />
								</div>
