					...
					<?php foreach ($posts as $posts_item): ?>
						...
						<div class="card mb-4">
							...
							<div class="card-body">
								...
								<div class="card-text post-shortened"><?= word_limiter($posts_item['post_text'], 140); ?> <sub><a href="<?= base_url('/posts/view/' . $posts_item['post_slug'] . '/' . $posts_item['post_id']); ?>">[ ›› ]</a></sub></div>
							</div>
